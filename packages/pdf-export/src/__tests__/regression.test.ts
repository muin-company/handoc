...
const cases: [string, number, number, string][] = [
  ...
  ['20260220/가곡.hwpx', 2, 1, '가곡'],                        // TODO: over by 1
  ['20260220/참석자 사전 의견서.hwpx', 1, 1, '참석자 사전 의견서'],
  ['20260220/[별지 7] 이의신청서(클라우드컴퓨팅서비스 보안인증에 관한 고시).hwpx', 2, 1, '이의신청서'], // TODO: over by 1
  ['20260220/230403 공공기관의 데이터베이스 표준화 지침 개정 전문.hwpx', 30, 24, 'DB 표준화 지침'], // TODO: over by 6
  // Education
  ['education/2015 개정 교육과정 성취기준.hwpx', 9, 7, '성취기준'],   // TODO: over by 2
  ['education/2025 역곡중 출결신고서 양식(간소화).hwpx', 1, 1, '출결신고서'],
  ['education/2025 출결 안내.hwpx', 2, 1, '출결 안내'],              // TODO: over by 1
  ['education/명심보감 필사(바른말).hwpx', 2, 2, '명심보감 필사'],
];
