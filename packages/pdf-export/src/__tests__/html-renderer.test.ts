...
describe('renderToHtml', () => {
  ...
  it('should render table with colspan and rowspan', () => {
    const tableElement = {
      tag: 'tbl',
      attrs: { id: 't1', rowCnt: '2', colCnt: '3', cellSpacing: '0', borderFillIDRef: '0' },
      children: [
        {
          tag: 'tr',
          attrs: {},
          children: [
            {
              tag: 'tc',
              attrs: {
                name: 'A1', header: '1', borderFillIDRef: '0',
                colAddr: '0', rowAddr: '0', colSpan: '2', rowSpan: '1',
              ...
              children: [{
                ...
                children: [{
                  ...
                  children: [{
                    tag: 'run',
                    attrs: {},
                    children: [{ tag: 't', attrs: {}, children: [], text: 'Merged cell' }],
                    text: null,
                  }],
                  text: null,
                }],
            ...
            },
            {
              tag: 'tc',
              attrs: {
                name: 'C1', header: '0', borderFillIDRef: '0',
                colAddr: '2', rowAddr: '0', colSpan: '1', rowSpan: '2',
              ...
              children: [{
                ...
                children: [{
                  ...
                  children: [{
                    tag: 'run',
                    attrs: {},
                    children: [{ tag: 't', attrs: {}, children: [], text: 'Tall cell' }],
                    text: null,
                  }],
                  text: null,
                }],
